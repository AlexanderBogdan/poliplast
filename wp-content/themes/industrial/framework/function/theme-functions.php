...
function cmsms_header_styles() {
	...
	echo '#middle.cmsms_middle_margin { ' . 
		...
		'@media only screen and (max-width : 1024px) { ' . 
			'.cmsms_responsive #middle.cmsms_middle_margin { ' . 
				'margin-top : 0px; ' . 
			'} ' . 
			'.cmsms_responsive .header_inner:after { ' . 
				'margin-left : 5%; ' . 
			'} ' . 
			'.cmsms_responsive #header nav { ' . 
				'top : auto; ' . 
				'left : auto; ' . 
			'} ' . 
			'.cmsms_responsive #header > .header_inner > a.logo { ' . 
				'top : auto; ' . 
				'left : auto; ' . 
			'} ' . 
		...
		'@media only screen and (max-width : 767px) { ' . 
			'.cmsms_responsive #header .search_line, .cmsms_responsive #header .social_icons { ' . 
				'top : auto; ' . 
				'left : auto; ' . 
			'} ' . 
		'} ' . 
		'@media only screen and (max-width : 450px) { ' . 
			'.cmsms_responsive .header_html { ' . 
				'top : auto; ' . 
			'} ' . 
			'.cmsms_responsive #header > .header_inner > a.logo { ' . 
				'width : 90%; ' . 
				'height : auto; ' . 
			'} ' . 
			'.cmsms_responsive #header > .header_inner > a.logo > img { ' . 
				'margin : 0 auto; ' . 
			'} ' . 
			'.cmsms_responsive .header_inner:after { ' . 
				'width : 90%; ' . 
